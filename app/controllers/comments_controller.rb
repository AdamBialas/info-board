class CommentsController < ApplicationController
  ...
  private
    ...
    def set_comment
      @comment = Info::Comment.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def comment_params
      params.require(:info_comment).permit(:text_, :info_id, :User_id, :parent_id)
    end
end
